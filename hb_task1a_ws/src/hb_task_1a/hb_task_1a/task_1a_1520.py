...
# Team ID: 1520
# Team Leader Name: Hridhay Kutty
# Team Members Name: Yash Gavit, Vaishnavi Mulik, Jiten Topiwala
...
#Here the second turtle is spawn with some offset.
    ...
    spawn_request.x = 5.197917                                               # X-coordinate for the new turtle's spawn location
    spawn_request.y = 5.197917                                               # Y-coordinate for the new turtle's spawn location  (offset is given because of initial default spawn)
