...
bool my_robot_interfaces__msg__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._goal.Goal", full_classname_dest, 34) == 0);
  }
  my_robot_interfaces__msg__Goal * ros_message = _ros_message;
  {  // bot_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "bot_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->bot_id = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // x
...
PyObject * my_robot_interfaces__msg__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._goal");
  ...
  {  // bot_id
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->bot_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "bot_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
