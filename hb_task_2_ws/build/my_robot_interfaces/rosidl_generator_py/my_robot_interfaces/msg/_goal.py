...
class Goal(metaclass=Metaclass_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.bot_id = kwargs.get('bot_id', int())
    ...
    def bot_id(self, value):
        if __debug__:
            assert \
                ...
                "The 'bot_id' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'bot_id' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._bot_id = value
